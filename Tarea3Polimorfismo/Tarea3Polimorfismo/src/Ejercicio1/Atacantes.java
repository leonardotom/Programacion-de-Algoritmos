 ...
 * @author leonardo
 */
public class Atacantes extends EstadisticaJugadores {
    
    public Atacantes(String nombre, int numeroDorsal, int rut, int golesMarcador, int pasesconExito, int baloresRecuperados) {
        super(nombre, numeroDorsal, rut, golesMarcador, pasesconExito, baloresRecuperados);
    }

    public int ValoracionGoles(){
        return super.ValoracionGoles() + this.pasesconExito*2 + this.baloresRecuperados*3;
    }
